...
const SCALE_INFO: Record<ScaleKey, ScaleInfo> = {
  eI: {
    ...
    whenHigh: '모임에 생기를 불어넣고, 단절된 관계를 연결하는 허브 역할을 합니다.',
    whenLow: '시끄럽지 않고 진심 어린 소수의 관계에 집중하는 깊이 있는 스타일입니다.',
  },
  ...
  wI: {
    ...
    whenHigh: '관계의 온기와 "우리"라는 감각을 깊게 느끼며 살아갑니다.',
    whenLow: '독립적인 시간과 자율성에서 에너지를 충전하는 스타일입니다.',
  },
  ...
  eC: {
    ...
    whenHigh: '방향을 잃은 팀에 기준점을 제시하고, 빠른 결정으로 흐름을 만들어냅니다.',
    whenLow: '강압 없이 협력과 합의를 만들어내는 수평적인 힘을 발휘합니다.',
  },
  ...
  wC: {
    ...
    whenHigh: '구조화된 환경에서 놀라울 정도로 정밀하고 꾸준한 성과를 만들어냅니다.',
    whenLow: '자유로운 환경에서 독립적으로 큰 그림을 그려내는 힘을 발휘합니다.',
  },
  ...
  eA: {
    ...
    whenHigh: '따뜻한 말과 행동으로 관계에 생기를 불어넣는 관계의 정원사입니다.',
    whenLow: '말보다 행동으로, 얕은 공감보다 깊은 신뢰로 사랑을 표현하는 스타일입니다.',
  },
  ...
  wA: {
    ...
    whenHigh: '사랑받는다는 느낌 속에서 자기다움이 깊이 피어나는 스타일입니다.',
    whenLow: '말이나 감정보다 묵직한 신뢰와 존중에서 사랑을 느끼는 스타일입니다.',
  },
};
